...
// =============================================================================
// Root/Extended System Description Tables
// =============================================================================
...
typedef struct {
    ...
    // Latencies and Cache Information
    ...
    // Extended PM Register Blocks (GAS)
    acpi_gas_t x_pm1a_event_block;  // PM1a Event Register Block
    acpi_gas_t x_pm1b_event_block;  // PM1b Event Register Block
    acpi_gas_t x_pm1a_control_block;// PM1a Control Register Block
    acpi_gas_t x_pm1b_control_block;// PM1b Control Register Block
    acpi_gas_t x_pm2_control_block; // PM2 Control Register Block
    acpi_gas_t x_pm_timer_block;    // PM Timer Control Register Block
    acpi_gas_t x_gpe0_block;        // GPE0 Register Block
    acpi_gas_t x_gpe1_block;        // GPE1 Register Block
    acpi_gas_t sleep_control_reg;   // Sleep Control Register
    acpi_gas_t sleep_status_reg;    // Sleep Status Register
...
typedef struct {
    ...
    uint32_t flags;                 // Local APIC flags
    uint32_t acpi_id;               // ACPI processor UID
...
typedef struct {
    ...
    acpi_gas_t base_address;        // Base Address
...
// =============================================================================
extern acpi_rsdp_v2_t *acpi_rsdp;
extern acpi_rsdt_t *acpi_rsdt;
extern acpi_xsdt_t *acpi_xsdt;
extern acpi_fadt_t *acpi_fadt;
extern acpi_facs_t *acpi_facs;
extern acpi_dsdt_t *acpi_dsdt;
extern acpi_madt_t *acpi_madt;
extern acpi_hpet_t *acpi_hpet;
extern acpi_mcfg_t *acpi_mcfg;
extern acpi_srat_t *acpi_srat;
extern acpi_slit_t *acpi_slit;
extern acpi_bert_t *acpi_bert;
...
/**
 * Get specific ACPI table by signature
...
/**
 * Check if a specific ACPI table is available
 * @param signature 4-character table signature
 * @return true if table is available, false otherwise
 */
bool acpi_table_available(const char *signature);
